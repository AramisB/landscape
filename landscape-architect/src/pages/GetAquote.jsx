...
const GetAquote = () => {
  return (
    <div className="max-w-2xl mx-auto p-8 bg-gray-50 font-sans">
      <h1 className="text-3xl font-bold text-green-700 mb-4">Get a Quote for Your Landscape Project</h1>
      <p className="text-lg text-gray-700 mb-2">Looking to transform your outdoor space? Fill out the form below to get a personalized quote for your landscape project.</p>
      <p className="text-base text-gray-600 mb-2">Our services include:</p>
      ...
      <form className="flex flex-col gap-4">
        ...
        <button type="submit" className="w-fit px-6 py-2 bg-green-700 text-white font-semibold text-base border-none rounded-none hover:bg-green-600 transition">Submit</button>
      </form>
    </div>
  );
};
